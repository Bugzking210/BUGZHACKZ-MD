...
const ownerNumber = ['263780667006']
...
console.log("CONNECTING BUGZKINGZ-MD 🧬...");
...
console.log('BUGZKINGZ-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ BUGZKINGZ-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ TECH TREEZY ✅*
...
//================ownerreact==============
if(senderNumber.includes("2637143922")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("263714373922")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("263780667006")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, BUGZKINGZ-MD STARTED ✅");
});
